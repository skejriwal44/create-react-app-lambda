...
import { SyncOutlined, MenuOutlined, CloseOutlined, LeftOutlined, DownOutlined, SettingOutlined, LoadingOutlined, CloseCircleTwoTone, PaperClipOutlined, PlusOutlined, ArrowUpOutlined, DeleteOutlined, UserAddOutlined, SendOutlined } from '@ant-design/icons';
...
function getLatestMessages(props, chatId, count, callback) {
  axios.get(getApiUrl(props) + "/chats/" + chatId + "/messages/latest/" + count + "/", {
    ...
    props.onGetMessages && props.onGetMessages(chatId, response.data);
    console.log("Called getLatestMessages")
    callback && callback(chatId, response.data);
  })["catch"](function (error) {
...
function sendMessage(props, chatId, data, callback) {
  ...
  // console.log("Message has been sent here", isBottomVisible)
}
...
var TheirMessage = function TheirMessage(props) {
  ...
  var is_spam = message.text.includes("$SPAM$")? 'red':'black'; //chane $SPAM$ to relevant SPAM FLTER KEYWORD
  ...
  }, message.sender_username.split("@")[0]), /*#__PURE__*/React.createElement(Row, {
    style: {
      paddingLeft: '2px'
    },
  ...
  }, message.text.split("$SPAM$")[0]))), /*#__PURE__*/React.createElement(Col, {    //chane $SPAM$ to relevant SPAM FLTER KEYWORD
    xs: 9,
    style: {
      marginLeft: '48px'
    },
...
var ChatFeed = function ChatFeed(props) {
  ...
  function onGetMessages(chatId, messages, scrollDownTo) {
    console.log(props.projectID, messages)
...
var Button = /*#__PURE__*/function (_Component) {
  ...
  _proto.render = function render() {
    ...
    }, icon === 'plus' && /*#__PURE__*/React.createElement(PlusOutlined, null), icon === 'send' && /*#__PURE__*/React.createElement(SendOutlined, null), icon === 'delete' && /*#__PURE__*/React.createElement(DeleteOutlined, null), icon === 'user-add' && /*#__PURE__*/React.createElement(UserAddOutlined, null), value && icon ? " " + value : value);
  };
